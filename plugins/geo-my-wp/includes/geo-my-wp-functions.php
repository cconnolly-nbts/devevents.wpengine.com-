...
abstract class GMW {
    ...
    <div class="spacer">
        <article id="content">
            ...
            <p>There were no results for our search. Please <a href="/tr-search-results/">try your search again</a>.</p></div>';
        	echo apply_filters( 'gmw_'.$this->form['form_type'].'_no_results_message', $no_results, $this->form );
        
        	do_action( 'gmw_'.$this->form['form_type'].'_after_no_results', $this->form ). '</div></div></div></div></div>'; 
