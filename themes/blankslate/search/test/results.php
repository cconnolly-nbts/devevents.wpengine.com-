...
ini_set('soap.wsdl_cache_ttl', '0'); 
    ...
    $query = "SELECT Participant_First_Name__c, Participant_Last_Name__c, Participant_Page_URL__c, Participant_Goal__c, Event_Name__c, Search_Team_Name__c
              FROM NBTS_Registrations__c  
              WHERE Participant_First_Name__c = '$first_name' OR Participant_Last_Name__c = '$last_name' OR Event_Name__c = '$team_name' ";
...
if ($response  != 0) {
    ...
    foreach ($response->records as $record) {
        ...
        <p>Team: " . $record->Search_Team_Name__c ."</p>
      ...
      echo '<p>There were no results for your search. Please try <a href="search.php">your search again</a>.</p>';
    }
