...
$query = "SELECT Participant_First_Name__c, Participant_Last_Name__c, Participant_Page_URL__c, Team__r FROM NBTS_Registrations__c  WHERE Event_Name__c = 'Nashville Brain Tumor Race' ";
$response = $mySforceConnection->query($query);
